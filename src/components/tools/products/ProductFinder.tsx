                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {[
                                    ...
                                    <button
                                        key={index}
                                        onClick={() => router.push(`/find-products/search-results?q=${encodeURIComponent(search.query)}`)}
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {([
                                    ...
                                    <button
                                        key={index}
                                        onClick={() => router.push('/find-products/search-results')}
                ...
                <div className="lg:ml-80 px-4 md:px-6 py-6">
                    ...
                    <section className="mb-8">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                                onClick={() => router.push('/find-products/search-results?category=deals')}
                    ...
                    <section className="mb-8">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                                onClick={() => router.push('/find-products/user-profile?tab=history')}
                                className="text-primary text-sm font-medium hover:text-primary-700 transition-colors duration-200"
                            >
                                View All
                            </button>
                    ...
                    <section className="mb-8">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                                onClick={() => router.push('/find-products/search-results?sort=popular')}
                                className="text-primary text-sm font-medium hover:text-primary-700 transition-colors duration-200"
                            >
                                View All
                            </button>
                    ...
                    <section className="mb-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                            ...
                            {([
                                ...
                                <button
                                    key={index}
                                    onClick={() => router.push(`/find-products/search-results?category=${category.name.toLowerCase()}`)}
