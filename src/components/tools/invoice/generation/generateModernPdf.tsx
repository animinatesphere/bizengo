...
export const InvoiceDocument: React.FC<InvoiceDocumentProps> = ({ data }) => {
    // console.log("logo3", data.businessLogo);
    return (
        <Document>
            <Page size="A5" style={styles.page}>
                <View style={styles.header}>
                    <View style={styles.headerContent}>
                        {data.businessLogo && (
                            <Image src="https://api.rootsnsquares.com/innovations/uploads/1752661788_68777f1c073ca.jpg" style={styles.logo} />
                        )}
                ...
                <View style={styles.footer} fixed>
                    ...
                    <Link src="https://bizengo.com/invoice-generator/">
                        <Text style={styles.link}>https://bizengo.com/invoice-generator/</Text>
                    </Link>
                </View>
            </Page>
        </Document>
