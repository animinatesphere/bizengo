...
Battery health is at 95% and the device has never been dropped or damaged. All functions work perfectly including Face ID, cameras, and wireless charging.`,
    ...
    const handleBuyNow = () => {
        ...
        // router.push('/find-products/checkout'); // Removed state because not serializable
    };

    const handleContactSeller = () => {
        // No direct product property access, so no null check strictly needed here
        // router.push('/find-products/messages'); // Removed state because not serializable
    };
                ...
                <div className="max-w-7xl mx-auto px-6 py-8">
                    ...
                    <div className="mt-12">
                        <SimilarProducts
                            ...
                            onProductClick={(productId) => router.push(`/find-products/product-detail?id=${productId}`)}
                        />
                    </div>
                </div>
            </div>
