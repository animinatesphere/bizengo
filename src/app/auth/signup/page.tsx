  ...
  return (
    <div className="min-h-screen bg-[#f1ece5] flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <Card className="border border-amber-600/30 shadow-2xl bg-white/80 backdrop-blur-lg rounded-2xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-3xl font-bold text-amber-700 mb-1">
              Create Account
            </CardTitle>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="h-11 bg-[#f1ece5] border border-amber-600/30 focus:border-amber-600 rounded-lg px-4"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="zip" className="font-semibold text-gray-700">
                  Zip Code
                </Label>
                <Input
                  id="zip"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    onChange={handleInputChange}
                    required
                    className="h-11 pr-10 bg-[#f1ece5] border border-amber-600/30 focus:border-amber-600 rounded-lg px-4"
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-amber-600 hover:bg-[#16274e] text-white font-bold rounded-lg shadow-lg transition-colors duration-300"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
